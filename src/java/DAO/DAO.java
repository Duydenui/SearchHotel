...
public class DAO {
    ...
    public List<Hotel> getBestHotel() {
        List<Hotel> list = new ArrayList<>();
        String query = "SELECT TOP 3 h.hotel_id, h.name, h.address, h.phone, h.description, h.rating, h.price_range, h.image_url, c.cname AS country_id\n"
                + "FROM hotels h\n"
                + "JOIN countries c ON h.country_id = c.cid\n"
    ...
    public static void main(String[] args) {
        ...
        String cid = null;
        List<Hotel> listCid = dao.getHotelByCountry(cid);
        for (Hotel hotel : listCid) {
